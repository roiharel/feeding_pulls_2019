...
#'This code is exactly what Strandburg-Peshkin et al 2015 developed and is published on http://crofoot.ucdavis.edu/data-sets--code.html
...
load("/Users/danpapag/Dropbox/replicate_baboons/scripts/after_PLOSbio_revisions/data/wing_tags/ys.Rdata")
load("/Users/danpapag/Dropbox/replicate_baboons/scripts/after_PLOSbio_revisions/data/wing_tags/xs.Rdata")


#use the indexes of day starts as the breaks
load("~/day.start.idxs.Rdata")
...
events_ <- events[which(events$disparity >= min.disparity & events$strength >= min.strength),]

#"events" now contains all of the interactions which have been discovered

save(events_, file= "~/events_thresholds_30_35_01_01.Rdata")
